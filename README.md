A simple, responsive to-do list application built with HTML, CSS, and JavaScript. This app allows users to add tasks, view them in a list, and delete tasks once they are completed.
